...
export function kitty() {
    ...
    const kcc = options.kitty.cursor.color.value
    const kctc = options.kitty.cursor.text_color.value
    ...
    const kuc = options.kitty.url.color.value
    const kus = options.kitty.url.style.value
    const kuu = options.kitty.url.underline.value
    const kcsf = options.kitty.color_scheme.fg.value
    const kcsb = options.kitty.color_scheme.bg.value
    const kcsbo = options.kitty.color_scheme.bg_opacity.value
    const kcsbb = options.kitty.color_scheme.bg_blur.value
    const kcssf = options.kitty.color_scheme.selection_fg.value
    const kcssb = options.kitty.color_scheme.selection_bg.value
