...
export default function gtk3(red, green, yellow, blue, magenta, teal, orange, accent, accentfg, fg, bg) { return `@keyframes ripple {
  to {
...
@keyframes ripple-on-headerbar {
  ...
  to {
    background-image: radial-gradient(circle, ${accent} 100%, transparent 0%);
  }
}
...
* {
  ...
  -GtkTextView-error-underline-color: ${red};
...
@keyframes needs-attention {
  from {
    background-image: -gtk-gradient(radial, center center, 0, center center, 0.001, to(${accent}), to(transparent));
  }
  to {
...
frame.bottom.documents-dropdown, .bottom.app-notification, toolbar.osd.bottom {
  box-shadow: none;
  background-color: transparent;
  background-image: linear-gradient(to bottom, transparent, alpha(${bg}, 0.1) 30%, alpha(${bg}, 0.2) 50%, alpha(${bg}, 0.4));
}
...
popover.background:backdrop, .csd popover.background:backdrop {
  box-shadow: 0 3px 3px -2px alpha(${bg}, 0.05), 0 2px 3px -1px alpha(${bg}, 0.06), 0 1px 4px 0 alpha(${bg}, 0.05), 0 0 0 1px alpha(${bg}, 0.75);
}
...
colorswatch#editor-color-sample overlay:hover {
  box-shadow: 0 2px 3px -2px alpha(${bg}, 0.3), 0 1px 2px -1px alpha(${bg}, 0.24), 0 1px 2px -1px alpha(${bg}, 0.17);
}
...
decoration {
  transition: none;
  border-radius: 12px;
  box-shadow: 0 1px 3px 0 alpha(${bg}, 0.2), 0 15px 16px 2px alpha(${bg}, 0.14), 0 6px 18px 5px alpha(${bg}, 0.12), 0 0 0 1px alpha(${bg}, 0.75), 0 0 36px transparent;
  margin: 10px;
}
...
decoration:backdrop {
  transition: box-shadow 200ms ease-out;
  box-shadow: 0 1px 2px 0 alpha(${bg}, 0.15), 0 3px 3px 0 alpha(${bg}, 0.18), 0 3px 6px 0 alpha(${bg}, 0.12), 0 0 0 1px alpha(${bg}, 0.75), 0 0 36px transparent;
}
...
.ssd decoration {
  border: none;
  border-radius: 12px 12px 0 0;
  box-shadow: 0 0 0 1px alpha(${bg}, 0.75);
}
...
button.minimize.titlebutton:active:not(.suggested-action):not(.destructive-action), button.maximize.titlebutton:active:not(.suggested-action):not(.destructive-action), button.close.titlebutton:active:not(.suggested-action):not(.destructive-action) {
  box-shadow: inset 0 0 0 9999px alpha(${bg}, 0.12);
  background-image: radial-gradient(circle, alpha(${bg}, 0.12) 10%, transparent 0%);
}
...
#MozillaGtkWidget.background headerbar.titlebar.default-decoration button.minimize.titlebutton:hover, .background.csd headerbar.titlebar.default-decoration button.minimize.titlebutton:hover:not(.suggested-action):not(.destructive-action), #MozillaGtkWidget.background headerbar.titlebar.default-decoration button.minimize.titlebutton:active, .background.csd headerbar.titlebar.default-decoration button.minimize.titlebutton:active:not(.suggested-action):not(.destructive-action) {
  background-image: -gtk-scaled(url("assets/scalable/minimize-symbolic.svg"), url("assets/scalable/minimize-symbolic@2.svg"));
}
...
#MozillaGtkWidget.background headerbar.titlebar.default-decoration button.maximize.titlebutton:hover, .background.csd headerbar.titlebar.default-decoration button.maximize.titlebutton:hover:not(.suggested-action):not(.destructive-action), #MozillaGtkWidget.background headerbar.titlebar.default-decoration button.maximize.titlebutton:active, .background.csd headerbar.titlebar.default-decoration button.maximize.titlebutton:active:not(.suggested-action):not(.destructive-action) {
  background-image: -gtk-scaled(url("assets/scalable/maximize-symbolic.svg"), url("assets/scalable/maximize-symbolic@2.svg"));
}
...
#MozillaGtkWidget.background headerbar.titlebar.default-decoration button.close.titlebutton:hover, .background.csd headerbar.titlebar.default-decoration button.close.titlebutton:hover:not(.suggested-action):not(.destructive-action), #MozillaGtkWidget.background headerbar.titlebar.default-decoration button.close.titlebutton:active, .background.csd headerbar.titlebar.default-decoration button.close.titlebutton:active:not(.suggested-action):not(.destructive-action) {
  background-image: -gtk-scaled(url("assets/scalable/close-symbolic.svg"), url("assets/scalable/close-symbolic@2.svg"));
}
...
.background.csd.maximized headerbar.titlebar.default-decoration button.titlebutton:not(.suggested-action):not(.destructive-action).maximize:hover, .background.csd.maximized headerbar.titlebar.default-decoration button.titlebutton:not(.suggested-action):not(.destructive-action).maximize:active {
  background-image: -gtk-scaled(url("assets/scalable/unmaximize-symbolic.svg"), url("assets/scalable/unmaximize-symbolic@2.svg"));
}
...
docktab {
  ...
  background-image: radial-gradient(circle, ${accent} 10%, transparent 0%);
  background-repeat: no-repeat;
  background-position: center;
  background-size: 0% 0%;
  color: alpha(${fg}, 0.7);
...
ideeditorutilities > dzldockpaned > box > stackswitcher button:active {
  background-image: radial-gradient(circle, alpha(${accent}, 0.7) 10%, transparent 0%);
}
...
.side-panel .view:selected:hover {
  background-image: image(alpha(${accent}, 0.9896));
}
...
overlay > revealer.left > scrolledwindow.frame, overlay > revealer.right > scrolledwindow.frame {
  border-style: none;
  box-shadow: 0 1px 3px 0 alpha(${bg}, 0.2), 0 15px 16px 2px alpha(${bg}, 0.14), 0 6px 18px 5px alpha(${bg}, 0.12);
}
...
UnityDecoration {
  ...
  -UnityDecoration-active-shadow-color: alpha(${bg}, 0.48);
  -UnityDecoration-active-shadow-radius: 18px;
  -UnityDecoration-inactive-shadow-color: alpha(${bg}, 0.32);
...
.budgie-notification-window, .budgie-switcher, .budgie-switcher-window, .budgie-osd-window {
  background-color: transparent;
}
...
.budgie-run-dialog.background.csd > decoration {
  border: none;
  box-shadow: 0 1px 3px 0 alpha(${bg}, 0.2), 0 15px 16px 2px alpha(${bg}, 0.14), 0 6px 18px 5px alpha(${bg}, 0.12), 0 0 0 1px alpha(${bg}, 0.75);
}
