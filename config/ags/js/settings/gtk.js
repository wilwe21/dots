...
function gtkupdate() {
    ...
    const agstheme = `@keyframes ripple {
  to {
...
columnview.view,
treeview.view {
  border-left-color: #3e4152;
  border-top-color: #3e4152;
}
...
paned > separator.wide {
  ...
  min-height: 6px;
  background-color: ${bg};
  background-image: image(#3e4152), image(#3e4152);
